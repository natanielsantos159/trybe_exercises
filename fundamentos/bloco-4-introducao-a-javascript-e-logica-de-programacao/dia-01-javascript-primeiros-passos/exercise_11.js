...
let salarioLiquido;
let aliquotaINSSPorcentagem;
let aliquotaINSSValor;
let aliquotaIR;
let parcelaIR;

if (salarioBase <= 1556.94){
  aliquotaINSSPorcentagem = 0.8;
} else if(salarioBase >= 1556.95 && salarioBase <= 2594.92){
  aliquotaINSSPorcentagem = 9;
} else if(salarioBase >= 2594.93 && salarioBase <= 5189.82){
  aliquotaINSSPorcentagem = 11;
} else {
  let aliquotaINSSValor = 570.88;
}

if (aliquotaINSSValor == undefined) {
  aliquotaINSSValor = salarioBase * aliquotaINSSPorcentagem / 100;
  console.log(aliquotaINSSValor)
